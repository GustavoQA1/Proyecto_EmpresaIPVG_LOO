...
namespace GUARDAR_IPVG
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Rut: "+ e.rut_empleado+ " / "+ "Nombre Empleado: "+ e.nombre_empleado + " "+ e.apellido_empleado+ " / "
                              + "cargo: "+ c.nombre_cargo+ " / "+ "Jefe: "+ j.nombre_jefe + " "+ j.apellido_jefe+ " / "+"departamento: "+ d.nombre_departamento);
            Console.ReadKey();
